class LikesController < ApplicationController
  ...
  def create
    ...
    if like.save
      render json: { id: like.id, email: current_user.email, messages:'成功しました' }, status: :ok
    else
  ...
  def destroy
    ...
    if like.destroy
      ...
      render json: { message: '削除出来ませんでした', errors: like.errors.messages }, status: :bad_request
    end
  end
end
